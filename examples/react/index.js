function init() {
	var json = {
		...
		pages: [
            {"name":"page1","elements":[{"type":"html","name":"question1","html":"<div>Используется для:\n\n1. Заблаговременной проработки потребностей клиентов\n2. Хорошего проектирования универсальных решений\n3. Глубокое погружение аналитиков и конструкторов в возможности платформы и в функционал системы (применение возможностей платформы при генерации решений и избежание дублирования функционала)</div>"}]},
			{
				elements: [
					{
						type: "text",
